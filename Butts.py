...
# --- SEARCH MODELS (FROM NEW SEARCH.PY LOGIC) ---
...
# --- SEARCH LORAS (FROM NEW SEARCH.PY LOGIC) ---
...
def search_loras():
    ...
    variables = {
        "first": 20,
        "types": ["ANY_LORA"],
        "loraBaseModelTypes": ["SDXL_MODEL"], # From new search.py
        "feed": feed,
        "keyword": d.get("keyword")
    }
    if d.get("cursor"): variables["after"] = d.get("cursor")
