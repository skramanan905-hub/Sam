...
# --- FOCUS: TASK LIST (NEW TO OLD) ---
@app.route('/api/tasks', methods=['POST'])
def get_web_tasks():
    d = request.json
    t, cursor = d.get("token"), d.get("cursor")
    # We use 'last' instead of 'first' and specific sorting to ensure Newest is at Top
    p = {
    ...
    try:
        ...
        # We reverse the order of edges to put Newest at the Start of the array
