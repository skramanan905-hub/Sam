...
# --- 1. GENERATION (EXACT 15s POLLING LOGIC FROM YOUR SNIPPET) ---
...
# --- 2. TASK LIST (IMPROVED TO FETCH ALL HISTORY VIA CURSOR) ---
...
def get_web_tasks():
    ...
    try:
        ...
        return jsonify({"status": "success", "tasks": task_data, "cursor": page_info['endCursor'] if page_info['hasNextPage'] else None})
    except: return jsonify({"status": "error"})

# --- 3. REFERENCE UPLOAD (3-STEP) ---
