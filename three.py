...
def run_generation():
    ...
    neg, final_triggers = d.get("neg", ""), d.get("triggers", "")
    ...
    for lid in lora_ids:
        ...
        if meta:
            ...
            l_p.append({"versionId": meta['v_id'], "weight": lora_str, "triggerWords": final_triggers, "positionInfo": {"startIndex": 0, "endIndex": 0}})

    payload = {
        "operationName": "createGenerationTask",
        "variables": {
            "parameters": {
                "prompts": prompt + ", " + final_triggers, "negativePrompts": neg,
