...
H_COST   = "50567e9680327f27a692e76f62b1b3699b24467f3747b0e14d3345d2e3077395" # Real Cost Hash
...
def search_models():
    ...
    for e in res['data']['generationModels']['edges']:
        ...
        items.append({
            "name": n['title'], 
            "id": n['latestAvailableVersion']['id'] if n.get('latestAvailableVersion') else n['id'], 
...
def search_loras():
    ...
    for e in res['data']['generationModels']['edges']:
        n = e['node']
        items.append({
            "name": n['title'], "id": n['id'], "thumb": next((u['url'] for u in n['media']['urls'] if u['variant'] == "STILL_THUMBNAIL"), ""),
