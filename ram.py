...
# ================= MASTER CONFIGURATION (IDENTICAL TO SEVEN.PY) =================
...
def generate():
    ...
    # MODIFIED: Now uses the model selected on web, or defaults to Haruka v2
    ...
    try:
        ...
        for edge in reversed(edges):
            ...
            if node.get('status') == "completed":
                ...
                if img: task_data.append({"url": img, "prompt": clean_txt(node.get('parameters', {}).get('prompts', ""))})
